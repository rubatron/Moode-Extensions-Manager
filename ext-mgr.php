        ...
        <fieldset class="extmgr-panel">
            ...
            <div class="extmgr-grid">
                <div class="extmgr-metric">
                    <div class="extmgr-metric-label">API Service</div>
                    <div id="api-service" class="extmgr-metric-value">-</div>
                </div>
                <div class="extmgr-metric">
                    <div class="extmgr-metric-label">Registry</div>
                    <div id="registry-health" class="extmgr-metric-value">-</div>
                </div>
                <div class="extmgr-metric">
                    <div class="extmgr-metric-label">Extensions</div>
                    <div id="extension-count" class="extmgr-metric-value">-</div>
                </div>
                <div class="extmgr-metric">
                    <div class="extmgr-metric-label">Active</div>
                    <div id="active-count" class="extmgr-metric-value">-</div>
                </div>
                <div class="extmgr-metric">
                    <div class="extmgr-metric-label">Inactive</div>
