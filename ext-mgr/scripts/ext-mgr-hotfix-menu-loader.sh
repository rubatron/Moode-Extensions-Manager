...
INDEX_TEMPLATE_FILE="$MOODE_ROOT/templates/indextpl.min.html"
HEADER_FILE="$MOODE_ROOT/header.php"
FOOTER_MIN_FILE="$MOODE_ROOT/footer.min.php"
FOOTER_FILE="$MOODE_ROOT/footer.php"
INDEX_PHP_FILE="$MOODE_ROOT/index.php"
